...
dfp7 = pd.read_csv("../project/data/csv_files/data_additional_trump_1.csv", sep=";")
dfp8 = pd.read_csv("../project/data/csv_files/data_additional_trump_2.csv", sep=";")
...
if __name__ == "__main__":
    ...
    dataframes = [dfp1, dfp2, dfp3, dfp4, dfp5, dfp6, dfp7, dfp8]
